<?php // supreme_open_entry
	...
	<div class="post-blog-image">
		...
		<a href="<?php echo get_permalink(); ?>" title="<?php the_title_attribute( 'echo=1' ); ?>" rel="bookmark" class="featured-image-link"><img src="<?php get_the_image( array( 'size' => 'adv_detail-main-img', 'link_to_post' => false ) ); ?>"/></a>
	</div>
	<?php 
	else :
		$post_image = '';
		if(function_exists('directory_bdw_get_images_plugin')){ 
			$post_img = directory_bdw_get_images_plugin($post->ID,'adv_detail-main-img');			
	...
	<div class="entry-header">
	  ...
	  <h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'templatic' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?>
		</a>
	  </h2>
	  <?php  
