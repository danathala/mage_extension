...
class Kodematix_OnepageCheckout_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
    	return (string) Mage::getConfig()->getNode()->modules->Kodematix_OnepageCheckout->version;
    }
