...
//depends on accessories moduel for custom product linking 
class Tech_CustomExportImport_Model_ImportExport_Export_Entity_Product extends Mage_ImportExport_Model_Export_Entity_Product {
    ...
    protected function _prepareLinks(array $productIds)
    {
        ...
        $select = $adapter->select()
            ...
            ->where('cpl.link_type_id IN (?)', array(
                ...
                Anais_Accessories_Model_Product_Link::LINK_TYPE_ACCESSORIES // adding for accessories custom linking for module
            ))
    ...
    public function export()
    {
        ...
        while (true) {
            ...
            $linkIdColPrefix = array(
                ...
                Anais_Accessories_Model_Product_Link::LINK_TYPE_ACCESSORIES   => '_my_custom_associated_',
            );
            ...
            if ($offsetProducts == 1) {
                ...
                $headerCols = array_merge(
                    ...
                    array(
                        ...
                        '_my_custom_associated_sku', '_my_custom_associated_default_qty', '_my_custom_associated_position'
                    ),
