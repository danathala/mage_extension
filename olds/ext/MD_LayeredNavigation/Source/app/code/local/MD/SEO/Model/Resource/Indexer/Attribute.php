...
class MD_SEO_Model_Resource_Indexer_Attribute extends Mage_Index_Model_Resource_Abstract
{
    ...
    {
        $this->_init('md_seo/attribute_url_key', 'id');
    }

    /**
     * Reindex all
     *
     * @return MD_SEO_Model_Resource_Indexer_Attribute
     */
