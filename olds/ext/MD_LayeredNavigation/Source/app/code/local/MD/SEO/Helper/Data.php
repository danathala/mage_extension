...
class MD_SEO_Helper_Data extends Mage_Core_Helper_Data
{
    /**
    ...
    {
        return Mage::getStoreConfigFlag('md_seo/catalog/enabled');
    }
    ...
    public function isAjaxEnabled()
    {
        ...
        return Mage::getStoreConfigFlag('md_seo/catalog/ajax_enabled');
    }
    ...
    public function isMultipleChoiceFiltersEnabled()
    {
        ...
        return Mage::getStoreConfigFlag('md_seo/catalog/multiple_choise_filters');
    }
    ...
    public function isPriceSliderEnabled()
    {
        ...
        return Mage::getStoreConfigFlag('md_seo/catalog/price_slider');
    }
    ...
    {
        return '/' . Mage::getStoreConfig('md_seo/catalog/routing_suffix');
    }
